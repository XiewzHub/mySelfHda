...
![](/Users/xwz/Desktop/linuxfile/img/alc236code.png)
...
![](/Users/xwz/Desktop/linuxfile/img/矢量图命令.png)

使用`Sketch.app`打开生产的文件如下图

![](/Users/xwz/Desktop/linuxfile/img/完整节点图.png)

##### 下面就是路径推导过程

- 输入设备

我这里的0x12是麦克风输入，路径包括三个节点![](/Users/xwz/Desktop/linuxfile/img/0x12路径.png)
...
![](/Users/xwz/Desktop/linuxfile/img/0x14路径.png)
...
![](/Users/xwz/Desktop/linuxfile/img/PinConfigs提取ConfigData.png)
...
- 观察数据发现`01470C02`和`02170C02`比较特别，经过查询得他们要遵守这个公式:`Address`+`节点`+`71c`+`02`
  ...
  ![](/Users/xwz/Desktop/linuxfile/img/说明1.png)
...
**之前的修正如果没有做**，可以使用对照下表进行`PinDefault`的修正，这里引用一张图如下：![](/Users/xwz/Desktop/linuxfile/img/pinconfigs.png)
...
- 打开`Applealc-master/resources/ACL236`目录下的Platforms13.xml
  ...
  ![](/Users/xwz/Desktop/linuxfile/img/Platforms13图.png)
  ...
  + 设置麦克风输入 `Mic at Int N/A` 、`Mic at Ext Right`分别为`8->35->18`和`9->34->25`，如图
     ![](/Users/xwz/Desktop/linuxfile/img/麦克风输入.png)
  + 设置输出：内置扬声器和耳机分别为`20->2`和`33->3`，Line Out at Ext N/A暂时不设置，如果有需要再进行设置![](/Users/xwz/Desktop/linuxfile/img/扬声器和耳机.png)
  + 

   

- 打开`Applealc-master/resources/ACL236`目录下的info.plist，如图
  ![](/Users/xwz/Desktop/linuxfile/img/ACL的info修改.png)

- 打开`Applealc-master/resources/ACL236`目录下的layout13.xml，如图![](/Users/xwz/Desktop/linuxfile/img/layout13修改.png)

- 打开`Applealc-master/resources/pinconfigs.kext/contents`目录下的info.plist![](/Users/xwz/Desktop/linuxfile/img/插件里的info.png)
...
双击`AppleALC-master`目录下的`AppleALC.xcodeproj`启动xcode软件，点击▶️运行，成功之后会保存在`Products`文件夹下，可以在Finder中打开 ![](/Users/xwz/Desktop/linuxfile/img/编译驱动.png)
